$(window).on("turbolinks:load", function() {
  ...
  // 画像を新しく追加する場合
  $(".item__img__dropzone, .item__img__dropzone2").on("change", 'input[type= "file"].upload-image', function() {
  ...
  // 削除ボタン
  $(".item__img__dropzone, .item__img__dropzone2").on('click', '.btn_delete', function() {
